...
public class Coin_ServerMessageManager : MonoBehaviour
{
    ...
    private List<string> rowTexts = ["<br><line-height=90%>", "<br><line-height=90%>", "<br><line-height=90%>", "<br><line-height=90%>", "<br><line-height=90%>"];
    private List<ulong> rowPlayerIds = [0, 0, 0, 0, 0];
...
#pragma warning restore IDE0051 // Remove unused private members
    ...
    {
        rowTexts = ["<br><line-height=90%>", "<br><line-height=90%>", "<br><line-height=90%>", "<br><line-height=90%>", "<br><line-height=90%>"];
        rowPlayerIds = [0, 0, 0, 0, 0];
        heads_voters = 0;
        tails_voters = 0;
    }
}